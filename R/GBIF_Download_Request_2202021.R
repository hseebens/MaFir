...
setwd("/home/hanno/Bioinvasion/InvAccu/MarineExpansion/Workflow")     # Set working directory
...
SpecNames <-  read.table("Data/Input/SInAS_AlienSpeciesDB_2.3.1_FullTaxaList.csv",stringsAsFactors = F,header=T)$scientificName
...
write.csv2(GBIF_species, "Data/Input/SpeciesGBIFkeys.csv")
...
## save intermediate output #############################
write.csv2(GBIF_species, "Data/Input/SpeciesGBIFnRecords.csv")
